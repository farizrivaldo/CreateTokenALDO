...
contract ALDOMarketplace is ERC721URIStorage, Ownable {
    ...
    constructor(address _aldoTokenAddress) ERC721("ALDO NFT", "ALDONFT") Ownable(msg.sender) {
        aldoToken = IERC20(_aldoTokenAddress);
    }
    
    // Mint NFT - anyone can mint
    ...
    // Get all NFTs (for display purposes)
